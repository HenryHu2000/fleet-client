...
screen -S tunnel -dm sh -c 'ssh -o StrictHostKeyChecking=accept-new hh2119@maru01.doc.res.ic.ac.uk "sudo fuser -k 7777/tcp"; ssh -R 7777:localhost:22 hh2119@maru01.doc.res.ic.ac.uk;'
